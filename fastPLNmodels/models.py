...
class IMPS_PLN():
    ...
    def keep_records(self): 
        '''Keep some records in order to plot the evolution after.'''
    ...
    def fit(self, Y, O, covariates,  N_epoch_max, acc,lr = 0.015,
        ...
        Args : 
               ...
               N_epoch_max: int. The maximum number of times we will loop over 
                   the data. We will see N_epoch times each sample. 
