...
counts, covariates, offsets = get_simulated_count_data(n_samples=800)
...
pca = PlnPCA(counts, batch_size=15, rank=15)
pca.fit(nb_max_iteration=200, class_optimizer="Adam", verbose=True)
