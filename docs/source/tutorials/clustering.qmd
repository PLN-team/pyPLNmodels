...
We illustrate both using a single-cell RNA-seq dataset (@scmark) provided by the
`load_scrna` function of the package. Each row represents a cell and each column a gene. Cell types are
