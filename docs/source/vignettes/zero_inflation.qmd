...
Here, the latent variable \(W\) models the zero-inflation component of the data. The input data includes:
...
The rank is a hyperparameter that can be manually defined. Alternatively, a data-driven approach to rank selection can be performed using the `ZIPlnPCACollection` class. This class fits multiple models with different ranks:
