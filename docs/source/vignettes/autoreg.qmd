...
These models generally yield similar latent variables, even though the estimated parameters may be different betwen `full` `ar_type` and `diagonal` and `spherical` `ar_type`.
