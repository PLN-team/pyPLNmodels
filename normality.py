...
nb_max_iter = 800
nb_seed_count = 100
ns = [250, 500, 750, 1000, 1250, 1500, 1750, 2000, 2250, 2500, 2750, 3000][::-1]
# ns = [1000,2000,3000][::-1]
dims = [100][::-1]
# dims = [50, 100, 200][::-1]
# nb_covs = [1, 2, 3, 4][::-1]
...
df_n01.to_csv(f"csvs/res_nb_seed_count{nb_seed_count}_dims_{dims}diagonal.csv")
